                ...
                <table width="890" border="0" align="center" cellpadding="10" cellspacing="0" class="tablebottom">
                    <tr>
                        <td class="bordertdleftCopy">
                            <p><?php if ($_GET['msg'] == "Export") { ?>
                            <center>Export Success</center> <?php } ?>
                            </p>
                            <strong><span style="font-size: 18px;">Onychology Course 2021 (global) <a
                                            href="https://www.onychologycourse.eu/admin/adminer/adminer.php?username=&select=Onychologycourse_2021"
                            ...
                            <table width="100%" border="0">
                                ...
                                while ($row = mysqli_fetch_row($resultcatalogue)) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="https://www.onychologycourse.eu/admin/adminer/adminer.php?username=&edit=Onychologycourse_2021&where%5Bid%5D=<?php echo $id; ?>"
                                               target="_blank"><img width="24" height="24" src="edit2.png"/></a></td>

                                        <td>
                                            <a href="index.php?action=del&iddel=<?php echo $id; ?>&evdel=Onychologycourse_2021"
                ...
                <table width="890" border="0" align="center" cellpadding="10" cellspacing="0" class="tablebottom">
                    <tr>
                        <td class="bordertdleftCopy">
                            ...
                            <strong><span style="font-size: 18px;">Onychology Course 2021 (Français) <a
                                            href="https://www.onychologycourse.eu/admin/adminer/adminer.php?username=&select=Onychologycourse_2021&where%5B0%5D%5Bcol%5D=lang&where%5B0%5D%5Bop%5D=&where%5B0%5D%5Bval%5D=fr&where%5B01%5D%5Bcol%5D=&where%5B01%5D%5Bop%5D=&where%5B01%5D%5Bval%5D=&limit=50"
                                            target="_blank"><img src="edit.png"
                                                                 align="top"/></a></span></strong><br><br>
                            <table width="100%" border="0">
                                <tr>
                ...
                <table width="890" border="0" align="center" cellpadding="10" cellspacing="0" class="tablebottom">
                    <tr>
                        <td class="bordertdleftCopy">
                            ...
                            <strong><span style="font-size: 18px;">Onychology Course 2021 (English) <a
                                            href="https://www.onychologycourse.eu/admin/adminer/adminer.php?username=&select=Onychologycourse_2021&where%5B0%5D%5Bcol%5D=lang&where%5B0%5D%5Bop%5D=&where%5B0%5D%5Bval%5D=en&where%5B01%5D%5Bcol%5D=&where%5B01%5D%5Bop%5D=&where%5B01%5D%5Bval%5D=&limit=50"
                                            target="_blank"><img src="edit.png"
                                                                 align="top"/></a></span></strong><br><br>
                            <table width="100%" border="0">
                                <tr>
